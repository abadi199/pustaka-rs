...
var author$project$Entity$Category$parentExists = F2(
	function (category, set) {
		return A2(
			...
			A2(
				elm$core$Maybe$map,
				function (parentId) {
					return A2(elm$core$Set$member, parentId, set);
				},
				category.parentId));
	});
...
var author$project$Entity$Category$toTree = function (categories) {
	...
	var roots = A2(
		...
		categories);
	return A2(elm$core$List$map, toTreeHelper, roots);
};
...
var author$project$Entity$Category$list = function (msg) {
	return A3(
		...
		A2(
			...
			author$project$Entity$Category$toTree,
			elm$json$Json$Decode$list(author$project$Entity$Category$decoder)));
};
var author$project$Main$GetCategoriesCompleted = function (a) {
...
var author$project$Main$initialModel = {
	categories: author$project$ReloadableData$Loading,
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'NoOp':
				return A2(author$project$Main$check, model, elm$core$Platform$Cmd$none);
			case 'GetCategoriesCompleted':
				var data = msg.a;
				return A2(
...
var author$project$Route$parser = elm$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			elm$url$Url$Parser$map,
			function ($) {
				return author$project$Route$Category(
...
var author$project$Main$init = function (env) {
	var _n0 = A2(
		...
		author$project$Main$RouteChanged(
	...
	return _Utils_Tuple2(
		...
		elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					cmds,
					author$project$Entity$Category$list(author$project$Main$GetCategoriesCompleted)
				])));
};
...
var author$project$Main$view = function (model) {
	...
	if (_n0.$ === 'Main') {
		...
		return A2(
			...
			A2(author$project$Page$Main$view, model.categories, mainModel));
	} else {
		var text = _n0.a;
