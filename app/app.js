...
var _abadi199$pustaka_rs$Main$main = _elm_lang$html$Html$program(
	{init: _abadi199$pustaka_rs$Main$init, view: _abadi199$pustaka_rs$View$view, update: _abadi199$pustaka_rs$Update$update, subscriptions: _abadi199$pustaka_rs$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _abadi199$pustaka_rs$Main$main !== 'undefined') {
    _abadi199$pustaka_rs$Main$main(Elm['Main'], 'Main', undefined);
}
